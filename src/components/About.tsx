        ...
        <div className="relative mb-12">
          <div className="relative inline-block">
            ...
            <div className="absolute -top-2 -right-2">
              <Badge variant="secondary" className="bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300 border border-purple-200 dark:border-purple-700 animate-pulse">
                ✨ Available
              </Badge>
            </div>
          </div>
          ...
          <p className="text-lg text-muted-foreground/80 max-w-2xl mx-auto leading-relaxed">
            Transforming ideas into digital masterpieces through cutting-edge technology and creative excellence
          </p>
        </div>
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Specializing in innovative solutions that bring your vision to life
            </p>
          </div>
