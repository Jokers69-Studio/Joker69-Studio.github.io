...
const Header: React.FC = () => {
  const navigationItems = [
    ...
    { href: "#projects", label: "Projects", description: "Featured work & innovations" },
    { href: "#skills", label: "Skills", description: "Our technical expertise" },
  ];
              ...
              <NavigationMenuContent>
                <div className="grid gap-3 p-6 w-[300px]">
                  <div className="row-span-3">
                    <div className="mb-4">
                      <h4 className="font-medium text-sm text-muted-foreground">Get in touch</h4>
                    </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Sheet>
            <SheetTrigger asChild className="lg:hidden">
              <Button variant="outline" size="icon" className="hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 dark:hover:from-purple-950/30 dark:hover:to-pink-950/30 transition-all duration-300">
